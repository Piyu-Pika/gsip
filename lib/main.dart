            ...
            Padding(
              ...
              child: MaterialButton(onPressed:(){
                ...
                String pass=_passcontroller.text;
                 if  (
                emailpar==defemail && pass==defpassword){
                  if(value=="Teacher"){
                setState(() {
                 Navigator.push(context,MaterialPageRoute(builder: (context) =>const TeachereScreen()));
              });}
              if(value=="Student"){
                setState(() {
              ...
              if(value=="Parents"){
                setState(() {
                 Navigator.push(context,MaterialPageRoute(builder: (context) =>const ParentsPortal()));
              });
              }
              }else{
                text1="" ;
